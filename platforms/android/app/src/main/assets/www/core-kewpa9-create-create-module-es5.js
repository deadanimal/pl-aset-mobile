...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["core-kewpa9-create-create-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCoreKewpa9CreateCreatePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa9CreateCreateRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa9CreateCreateModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa9CreateCreatePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa9CreateCreatePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CreatePage = /*#__PURE__*/function () {
      function CreatePage(router, route, formBuilder, modalCtrl, loadingCtrl, toastCtrl, kewpa9Service, plt, alertController) {
        var _this = this;
        ...
        this.plt.backButton.subscribeWithPriority(10, function () {
          _this.router.navigate(['/core/kewpa9-list']);
        });
      }
      ...
      _createClass(CreatePage, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    params = this.route.snapshot.params['kewpa9_id'];
        ...
        key: "tambahInfoKewpa9",
        value: function tambahInfoKewpa9() {
          var info_kewpa9 = this.formBuilder.group({
            no_siri_pendaftaran: [''],
            catatan: [''],
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return this.kewpa9Service.create(this.kewpa9Form.value).subscribe(function (res) {
                      console.log(res);
                    }, function (err) {
                      console.log(err);
                    }, function () {
                      _this2.router.navigate(['/core/kewpa9-list']);
                    });
        ...
        key: "submitKewpa9Update",
        value: function submitKewpa9Update() {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return this.kewpa9Service.update(this.selected_id, this.kewpa9Form.value).subscribe(function (res) {
                      console.log(res);
                    }, function (err) {
                      console.log(err);
                    }, function () {
                      _this3.router.navigate(['/core/kewpa9-list/']);
                    });
        ...
        value: function getFormValues(params) {
          ...
          this.kewpa9Service.getOne(params).subscribe(function (res) {
            _this4.kewpa9FormValues = res;
        ...
        value: function setFormValues() {
          ...
          this.kewpa9FormValues.info_kewpa9.forEach(function (element) {
            var info = _this5.formBuilder.group({
              id: element.id,
            ...
            _this5.getInfoArray.push(info);

            _this5.count++;
            _this5.productLength = _this5.getInfoArray.length;
          });
        }
      }, {
        key: "getInfoArray",
    ...
    CreatePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/core/kewpa9/create/create.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./create.page.scss */
      "./src/app/core/kewpa9/create/create.page.scss"))["default"]]
    })], CreatePage);
    /***/
  }
}]);
//# sourceMappingURL=core-kewpa9-create-create-module-es5.js.map