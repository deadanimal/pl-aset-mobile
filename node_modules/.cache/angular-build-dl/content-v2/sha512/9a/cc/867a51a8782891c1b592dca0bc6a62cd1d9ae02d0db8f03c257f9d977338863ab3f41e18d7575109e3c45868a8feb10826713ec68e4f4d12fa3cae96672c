...
/* harmony import */ var _list_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./list.page */ "./src/app/core/kewpa10a/list/list.page.ts");
...
/* harmony import */ var _list_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./list-routing.module */ "./src/app/core/kewpa10a/list/list-routing.module.ts");
/* harmony import */ var _list_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./list.page */ "./src/app/core/kewpa10a/list/list.page.ts");
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _view_view_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/view.page */ "./src/app/core/kewpa10a/view/view.page.ts");
...
let ListPage = class ListPage {
    constructor(router, modalCtrl, kewpa10aService) {
        this.router = router;
    ...
    getKewpa10a() {
        this.kewpa10aService.getAll().subscribe((res) => {
            console.log(res);
            this.kewpa10a = res;
        }, (err) => {
            console.log(err);
    ...
    deleteKewpa10a(kewpa10a) {
        this.kewpa10aService.delete(kewpa10a.id).subscribe((res) => {
            console.log(res);
        }, (err) => {
            console.log(err);
        }, () => {
...
ListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./list.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/core/kewpa10a/list/list.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./list.page.scss */ "./src/app/core/kewpa10a/list/list.page.scss")).default]
    })
], ListPage);
...
//# sourceMappingURL=core-kewpa10a-list-list-module-es2015.js.map