...
/* harmony import */ var _create_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create.page */ "./src/app/core/kewpa8/create/create.page.ts");
...
/* harmony import */ var _create_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./create-routing.module */ "./src/app/core/kewpa8/create/create-routing.module.ts");
/* harmony import */ var _create_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./create.page */ "./src/app/core/kewpa8/create/create.page.ts");
...
let CreatePage = class CreatePage {
    constructor(router, route, formBuilder, modalCtrl, loadingCtrl, toastCtrl, kewpa8Service, plt, alertController) {
        this.router = router;
        this.route = route;
    ...
    submitKewpa8() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.kewpa8Service.create(this.kewpa8Form.value).subscribe((res) => {
                console.log(res);
            }, (err) => {
                console.log(err);
            }, () => {
    ...
    submitKewpa8Update() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.kewpa8Service.update(this.selected_id, this.kewpa8Form.value).subscribe((res) => {
                console.log(res);
            }, (err) => {
                console.log(err);
            }, () => {
    ...
    getFormValues(params) {
        this.kewpa8Service.getOne(params).subscribe((res) => {
...
CreatePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({ selector: 'app-create',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./create.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/core/kewpa8/create/create.page.html")).default, styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./create.page.scss */ "./src/app/core/kewpa8/create/create.page.scss")).default] })
], CreatePage);
...
//# sourceMappingURL=core-kewpa8-create-create-module-es2015.js.map