...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["core-kewpa21-create-create-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCoreKewpa21CreateCreatePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa21CreateCreateRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa21CreateCreateModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa21CreateCreatePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreKewpa21CreateCreatePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_services_kewpa21_kewpa21_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/shared/services/kewpa21/kewpa21.service */
    ...
    var CreatePage = /*#__PURE__*/function () {
      function CreatePage(router, route, formBuilder, modalCtrl, loadingCtrl, toastCtrl, kewpa21Service, plt, alertController) {
        var _this = this;
        ...
        this.plt.backButton.subscribeWithPriority(10, function () {
          _this.router.navigate(['/core/kewpa21-list']);
        });
      }
      ...
      _createClass(CreatePage, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    params = this.route.snapshot.params['kewpa21_id'];
        ...
        key: "initkewpa21Form",
        value: function initkewpa21Form() {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return this.kewpa21Service.create(this.kewpa21Form.value).subscribe(function (res) {
                      console.log(res);
                    }, function (err) {
                      console.log(err);
                    }, function () {
                      _this2.router.navigate(['/core/kewpa21-list']);
                    });
        ...
        key: "submitKewpa21Update",
        value: function submitKewpa21Update() {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return this.kewpa21Service.update(this.selected_id, this.kewpa21Form.value).subscribe(function (res) {
                      console.log(res);
                    }, function (err) {
                      console.log(err);
                    }, function () {
                      _this3.router.navigate(['/core/kewpa21-list']);
                    });
        ...
        key: "submitKewpa21UpdateSubmit",
        value: function submitKewpa21UpdateSubmit() {
                ...
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    return this.kewpa21Service.update(this.selected_id, this.kewpa21Form.value).subscribe(function (res) {
                      ...
                      _this4.router.navigate(['/core/kewpa21-list']);
                    });
        ...
        value: function getFormValues(params) {
          ...
          this.kewpa21Service.getOne(params).subscribe(function (res) {
            _this5.kewpa21 = res;
            _this5.kewpa21FormValues = res;
    ...
    CreatePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/core/kewpa21/create/create.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./create.page.scss */
      "./src/app/core/kewpa21/create/create.page.scss"))["default"]]
    })], CreatePage);
    /***/
  }
}]);
//# sourceMappingURL=core-kewpa21-create-create-module-es5.js.map